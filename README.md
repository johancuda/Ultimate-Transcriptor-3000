...
This simple web app helps you with correcting text transcriptions created using a transcription software. Try it online here : [Ultimate Transcriptor 3000](https://johancuda.github.io/Ultimate-Transcriptor-3000/).
...
You can run this app locally using [Live Server for VS Code](https://marketplace.visualstudio.com/items?itemName=ritwickdey.LiveServer) for example.
